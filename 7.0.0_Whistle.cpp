...
// IMPORTANT:If you cannot complie the codes successfully,try to disable the O2 code in this file!
//#include <windows.h>
#include <iostream>
//#include <iomanip>
//#include <sstream>
...
//  unsigned long long total_games_won = 0;
    ...
    cout<<"You are in ";
    if(limited) cout<<"Limited mode, some functions are unable to use.";
    else cout<<"Unlimited mode, all functions are able to use.";
    cout<<endl;
    cout<<"Type in a command to start."<<endl<<"If you need help,type in \"help\" or \"?\"."<<endl;
    cout<<"DO NOT CHANGE THE NUMBERS OF THE PERMISSION LIMITATIONS IN THE CODE TO AVOID ATTACKING."<<endl<<endl;
...
syshelper                - Get help of the system
...
Type any command and press Enter.
        ...
        else if(command=="syshelper") {
            cout<<"Here are some information and warnings of the system."<<endl;
            cout << R"(
            
=====WARNINGS=====

DO NOT CHANGE THE NUMBERS OF THE PERMISSION LIMITATIONS IN THE CODE TO AVOID ATTACKING.

DO NOT GIVE ANY UNTRUSTWORTHY FUNCTIONS THE PERMISSION LEVEL HIGHER THAN 1.

DO NOT CHANGE WHERE THE loop_start IS!
...
=====INFORMATION=====
        ...
        ========================================
            ...
            if(permission>=2) {
                ...
                cout << "Version:                        7.0.0 Whistle" << endl;
                ...
                cout << "singleLineWhenNotes:            " << (singleLineWhenNotes ? "true" : "false") << endl;
            }
            else cout<<"No Access."<<endl;
        }
        ...
        ========================================
          ...
          [N]Note settings(developing)->Enable multi-line note?
          [Q]Quit->Just quit.
        ========================================
    )" << endl;
                    string command_set="";
